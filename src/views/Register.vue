<template>
    ...
    <div class=" flex content-center justify-center items-center md:mt-10 py-20">
        ...
        <div class="p-4 text-center">
            ...
            <h1 class="flex-1 text-2xl py-5 font-bold underline underline-offset-8">Register Box</h1>
